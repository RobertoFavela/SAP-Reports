CREATE PROCEDURE U_DCTTOriginal (
...
group by
    ...
    pch1."LineTotal",
    Opch."Comments"
    --SELECT ojdt."Number",ojdt."RefDate",ojdt."TransType",Opch."DocNum" as "Factura",jdt1."Account" as "Cuenta",
    --	--sum(pch1."LineTotal") as "Cargo", 		
    --	pch1."LineTotal" as "Cargo",jdt1."Credit" as "Abono",
    --	pch1."OcrCode" as "Negocio", pch1."OcrCode2" as "Sucursal", pch1."OcrCode3" as "Area",
    --	pch1."OcrCode4" as "Ciclo", pch1."OcrCode5" as "Equipos", pch1."Project" as "Proyecto", Opch."Comments" as "Comentario"
    -- 
    --from ojdt join jdt1 on ojdt."TransId"= jdt1."TransId" 
    --	inner join OACT on jdt1."Account"="AcctCode"
    --	left join OPCH ON ojdt."BaseRef"=opch."DocNum"
    --	inner join pch1 on opch."DocEntry"=pch1."DocEntry" 
    --where  ojdt."TransType"=18 and pch1."AcctCode"=jdt1."Account" 
    --	and jdt1."CreatedBy"=pch1."DocEntry" and  jdt1."Credit"=0 and pch1."LineTotal"=jdt1."Debit" and oact."U_CodAgrup"=115.03 
    --	and ojdt."RefDate">=sFechaInicial and ojdt."RefDate"<=sFechaFinal 
    --	--and ojdt."Number"=2175
UNION ALL
