SELECT
    ...
    -- RETENCIONES
    COALESCE(RET."Retencion 1", 0) AS "ISR SERVICIOS PROFESIONALES (HONORARIOS)",
    COALESCE(RET."Retencion 2", 0) AS "ISR RESICO",
    COALESCE(RET."Retencion 3", 0) AS "ISR POR ARRENDAMIENTO",
    COALESCE(RET."Retencion 4", 0) AS "IVA RETENIDO FLETES",
    COALESCE(RET."Retencion 5", 0) AS "IVA RETENIDO SERVICIOS PROFESIONALES",
    COALESCE(RET."Retencion 6", 0) AS "IVA RETENIDO POR ARRENDAMIENTO"
